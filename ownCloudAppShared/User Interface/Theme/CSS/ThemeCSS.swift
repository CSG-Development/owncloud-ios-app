...
public struct ThemeCSSSelector: RawRepresentable, Equatable {
	...
	public static let more = ThemeCSSSelector(rawValue: "more")
	...
	// Content Elements
	public static let hcDropdownView = ThemeCSSSelector(rawValue: "hcDropdownView")
	...
	public static let secondaryText = ThemeCSSSelector(rawValue: "secondaryText")
	public static let primaryText = ThemeCSSSelector(rawValue: "primaryText")
