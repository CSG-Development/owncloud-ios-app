...
final public class CodeVerificationTooManyRequestsCardViewController: UIViewController, Themeable {
	...
	private lazy var titleLabel: UILabel = {
		...
		label.text = HCL10n.Auth.TooManyRequests.title
		return label
	}()
	...
	private lazy var descriptionLabel: UILabel = {
		...
		let text = HCL10n.Auth.TooManyRequests.description
	...
	private lazy var cancelButton: UIButton = {
		...
		button.setTitle(HCL10n.Auth.TooManyRequests.cancelButtonTitle, for: .normal)
