...
public final class UnableToDetectViewController: UIViewController, Themeable {
	...
	private lazy var titleLabel: UILabel = {
		...
		l.text = HCL10n.Auth.UnableToDetect.navbarTitle
		return l
	}()
	...
	private lazy var retryButton: UIButton = {
		...
		b.setTitle(HCL10n.Auth.UnableToDetect.retryButtonTitle, for: .normal)
	...
	private func updateLabels() {
		...
		headerLabel.attributedText = NSAttributedString(
			string: HCL10n.Auth.UnableToDetect.headerText,
			attributes: [
				.font: font,
		...
		let listItems = [
			HCL10n.Auth.UnableToDetect.point1,
			HCL10n.Auth.UnableToDetect.point2,
			HCL10n.Auth.UnableToDetect.point3,
			HCL10n.Auth.UnableToDetect.point4,
			HCL10n.Auth.UnableToDetect.point5,
			HCL10n.Auth.UnableToDetect.point6
		]
		...
		let full = NSMutableAttributedString(
			string: HCL10n.Auth.UnableToDetect.footerText,
			attributes: [
				.font: font,
		...
		let linkRange = (full.string as NSString).range(of: HCL10n.Auth.UnableToDetect.footerLinkText)
		full.addAttributes([
